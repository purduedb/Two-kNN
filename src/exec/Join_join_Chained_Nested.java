...
public class Join_join_Chained_Nested {
	...
	public Join_join_Chained_Nested(ArrayList<Tuple> E1, ArrayList<Tuple> E2, ArrayList<Tuple> E3, int k1_2, int k2_3){
	...
	public ArrayList<String> execute() {
		...
		for (Tuple tuple : E1) {
			...
			for (Tuple e2Tuple : fp.nearestNeighbours) {
				...
				fp2.k = k2_3;
				fp2.setFocalPoint(e2Tuple.xCoord, e2Tuple.yCoord);
